...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         en_en[4];   //[en]
   Int_t           en_id[4];   //[en]
   Float_t         en_cor_en[4];   //[en]
   Float_t         en_EtaSC[4];   //[en]
   Float_t         en_R9[4];   //[en]
   Int_t           en_gainSeed[4];   //[en]
   Bool_t          en_passId[4];   //[en]
   Bool_t          en_passIdLoose[4];   //[en]
   Bool_t          en_passIso[4];   //[en]
   Float_t         en_relIso[4];   //[en]
   Float_t         en_enSigmaValue[4];   //[en]
   Float_t         en_enScaleValue[4];   //[en]
   Float_t         en_enScaleStatUp[4];   //[en]
   Float_t         en_enScaleStatDown[4];   //[en]
   Float_t         en_enScaleSystUp[4];   //[en]
   Float_t         en_enScaleSystDown[4];   //[en]
   Float_t         en_enScaleGainUp[4];   //[en]
   Float_t         en_enScaleGainDown[4];   //[en]
   Float_t         en_enSigmaRhoUp[4];   //[en]
   Float_t         en_enSigmaRhoDown[4];   //[en]
   Float_t         en_enSigmaPhiDown[4];   //[en]
   Int_t           jet;
   Float_t         jet_px[13];   //[jet]
   Float_t         jet_py[13];   //[jet]
   Float_t         jet_pz[13];   //[jet]
   Float_t         jet_en[13];   //[jet]
   Float_t         jet_btag0[13];   //[jet]
   Float_t         jet_btag1[13];   //[jet]
   Float_t         jet_mass[13];   //[jet]
   Float_t         jet_area[13];   //[jet]
   Float_t         jet_pu[13];   //[jet]
   Float_t         jet_puId[13];   //[jet]
   Bool_t          jet_PFLoose[13];   //[jet]
   Bool_t          jet_PFTight[13];   //[jet]
   Int_t           jet_partonFlavour[13];   //[jet]
   Int_t           jet_hadronFlavour[13];   //[jet]
   Int_t           jet_mother_id[13];   //[jet]
   Float_t         jet_parton_px[13];   //[jet]
   Float_t         jet_parton_py[13];   //[jet]
   Float_t         jet_parton_pz[13];   //[jet]
   Float_t         jet_parton_en[13];   //[jet]
   Float_t         jet_genpt[13];   //[jet]
   Float_t         imet_pt[11];
   Float_t         imet_phi[11];
   Float_t         met_pt;
   Float_t         met_phi;
